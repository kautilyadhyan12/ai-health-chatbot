...
class DashboardApp {
    ...
    async init() {
        ...
        // Start periodic updates (health tips only)
    ...
    async loadUserData() {
        try {
            ...
            if (response && response.username) {
                ...
                // Fallback to username from HTML
    ...
    async loadDashboardData() {
        try {
            ...
            // Load analytics (less critical, can load later)
    ...
    async loadDashboardStats() {
        try {
            ...
            if (response && response.success) {
                ...
                // Also update activity chart if available
            ...
            // Fallback: Load from analytics API
    ...
    initCharts() {
        ...
        // Initialize activity chart with FIXED height
        const activityCtx = document.getElementById('activityChart');
        if (activityCtx) {
            // Set fixed dimensions on the canvas parent
            ...
            this.chartInstances.activityChart = new Chart(activityCtx.getContext('2d'), {
                ...
                options: {
                    responsive: true,
                    maintainAspectRatio: false,  // CRITICAL: This keeps chart inside container
                    animation: {
        ...
        // Initialize intent chart with FIXED size
        ...
        // Initialize usage chart for analytics - STATIC data
        ...
        // Initialize peak hours chart - STATIC data only
    ...
    updateCharts(data) {
        ...
        // ✅ DO NOT update charts - keep them static
        // Charts will only be created once on page load
    ...
    async sendMessage() {
        ...
        try {
            ...
            if (response.response) {
                ...
                // ✅ UPDATE: Show real-time notification
    ...
    updateAnalyticsChart(days) {
        ...
        // Charts are static to prevent infinite growth
    }
    ...
    async deleteAllHistory() {
        ...
        try {
            // We need to get all pages and delete them one by one
            // This is a simplified version - in production, you'd have a bulk delete endpoint
            Utils.showAlert('Bulk delete is not implemented in this demo', 'warning');

            // For demo purposes, we'll just clear the current view
            this.renderHistoryList([]);
            this.currentPage = 1;
            this.totalPages = 1;
            this.renderPagination();
    ...
    viewHistory(recordId) {
        // This would show a detailed view of the conversation
        // For now, we'll just show an alert
        Utils.showAlert(`Viewing record ${recordId} - Feature coming soon!`, 'info');
    }

    initSettings() {
        // Settings would be initialized here
        // For now, just log
    ...
    startPeriodicUpdates() {
        // Update health tip every 5 minutes
        setInterval(() => {
            this.updateHealthTip();
        }, 5 * 60 * 1000);

        // ❌ DISABLED: Chart refresh causing infinite growth
        // No automatic chart updates
    }
}
